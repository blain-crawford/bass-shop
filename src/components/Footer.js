    ...
    <div className={styles.footer}>
      <div className={styles.contactInfo}>
        <div class={styles.devImageContainer}>
          <img className={styles.devImage} alt='Blain Crawford' src='https://media-exp2.licdn.com/dms/image/D4E35AQFvtCA60WqxVw/profile-framedphoto-shrink_200_200/0/1646839310829?e=1655996400&v=beta&t=riAbXF3qwIlcR5o2_inARhUWD3ho7WnHAwgwiimofzI' />
        </div>
        <div className={styles.devDetails}>
          <h2 className={styles.devQuestion}>Looking for a developer?</h2>
          <p className={styles.devIntro}>Call Blain Crawford, the developer who built this site!</p>
          <p className={styles.website}>Look into his other work here</p>
          <a className={styles.ghLink} href='https://github.com/blain-crawford'>Blain Crawford's GitHub</a>
        </div>
      ...
      <div className={styles.footerLinks} target='_blank'>
        <div className={styles.linkContainer1}>
          <ul className={styles.aboutBassShop}>
            <li><span className={styles.listHeader}>About Bass Shop</span></li>
            <li>Careers</li>
        ...
        <div className={styles.linkContainer2}>
          ...
          <li><span className={styles.listHeader}>Customer Service</span></li>
        ...
        <div className={styles.linkContainer3}>
          ...
          <li><span className={styles.listHeader}>Ordering</span></li>
          <li>Free Catalog</li>
          <li>Gift Cards</li>
          <li>Bonus Bucks</li>
        ...
        <div className={styles.linkContainer4}>
          ...
          <li><span className={styles.listHeader}>Services</span></li>
          <li>Bass Workshop</li>
          <li>Music Store</li>
